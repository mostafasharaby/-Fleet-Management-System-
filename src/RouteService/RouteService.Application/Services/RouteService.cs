    ...
    public class RouteService : IRouteService
    {
        public class RouteService : IRouteService
        {
                ...
                int pageSize, int pageNumber, string filter = null, RouteStatus? status = null)
            {
                ...
                var routes = await _routeRepository.GetPagedAsync(pageSize, pageNumber, filter, status);
            ...
            public async Task<Route> CreateRouteAsync(
                string name, Guid vehicleId, Guid driverId, DateTime startTime, IEnumerable<RouteStop> stops)
            {
                ...
                try
                {
                    ...
                    await _routeOptimizationService.CalculateRouteMetricsAsync(route);
